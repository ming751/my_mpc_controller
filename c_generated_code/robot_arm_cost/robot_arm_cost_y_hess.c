...
#else
  #define CASADI_PREFIX(ID) robot_arm_cost_y_hess_ ## ID
#endif
...
/* robot_arm_cost_y_hess:(i0[8],i1[4],i2[0],i3[7],i4[],i5[3])->(o0[12x12,16nz]) */
...
CASADI_SYMBOL_EXPORT int robot_arm_cost_y_hess(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int robot_arm_cost_y_hess_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int robot_arm_cost_y_hess_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void robot_arm_cost_y_hess_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int robot_arm_cost_y_hess_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void robot_arm_cost_y_hess_release(int mem) {
}

CASADI_SYMBOL_EXPORT void robot_arm_cost_y_hess_incref(void) {
}

CASADI_SYMBOL_EXPORT void robot_arm_cost_y_hess_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int robot_arm_cost_y_hess_n_in(void) { return 6;}

CASADI_SYMBOL_EXPORT casadi_int robot_arm_cost_y_hess_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_real robot_arm_cost_y_hess_default_in(casadi_int i) {
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* robot_arm_cost_y_hess_name_in(casadi_int i) {
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* robot_arm_cost_y_hess_name_out(casadi_int i) {
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const casadi_int* robot_arm_cost_y_hess_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* robot_arm_cost_y_hess_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int robot_arm_cost_y_hess_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 6;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
...
CASADI_SYMBOL_EXPORT int robot_arm_cost_y_hess_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
